...
flags.DEFINE_integer('jobs', 2, 'thread or process number')
flags.DEFINE_integer('max_iter_number', 20000, 'control the max iteration number for trainning')
flags.DEFINE_integer('paths_number', 2, 'number of paths in each rollout')
flags.DEFINE_integer('max_path_length', 10000, 'timesteps in each path')
...
flags.DEFINE_boolean('render', True, 'whether to render image')
flags.DEFINE_boolean('train_flag', False, 'true for train and False for test')
...
flags.DEFINE_string('environment_name', 'MountainCarContinuous-v0', 'environment name')
